...
#define DRIVER_VERSION "QMMUSB Driver Version 1.05"

#define USBLCD_MINOR		199
		     ...
		     const struct usb_device_id *id)
{
    ...
    // Find the device by product ID
	if (le16_to_cpu(dev->udev->descriptor.idProduct) != 0x0003) {
